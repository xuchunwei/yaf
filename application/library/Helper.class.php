...
abstract class Helper {
	 ...
	 * @return component
	 */
	public static function loadComponent($c){
		$component = 'Com_'.ucfirst($c);
		...
		$file = APP_PATH .'/application/component/' . $component .'.php';
		...
		try{
			self::$obj[$hash] = new $component();
			return self::$obj[$hash];
		} catch(Exception $error) {
			$traceInfo = debug_backtrace();
			$error = 'Load Component '.$component.' FAILED !';
			self::raiseError($traceInfo, $error);
		}
	}
